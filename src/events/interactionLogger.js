...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isButton()) terminal.info(`${interaction.user.username} (${interaction.user.id}) | ${interaction.guild.name} ${interaction.guild.id} > [ ${interaction.customId} ] (Select Menu) Value: ${interaction.fields}`)
